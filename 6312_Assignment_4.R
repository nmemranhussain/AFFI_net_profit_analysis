...
# If we take 'Temperature' as an discreet value (i.e. Hot, Warm & Cold) we have to use ANOVA test
anova <- lm(NetProfit~Combo+Temp, data = aristocrats_data)
summary(anova)
etasq(anova, data = aristocrats_data, anova = TRUE, partial = FALSE)
