...
### Multivariate level  
- **The reason that the set of independent variables offers predictibility of the dependent variable in the population:** Here from ANOVA test in multivariate level, the Global F p-value is  5.666e-12. Explaining power of both independent variables in sample (Multiple R-squared) is  0.1674 and in population (Adjusted R-squared) is 0.1569. So, we can reasonably conclude that, the set of independent variables offers a statistically significant predicitibility of the dependent variable in the population. 
